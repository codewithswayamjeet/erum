        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-6">
              <img
                src="/lovable-uploads/228cc8d9-9fb2-47a6-a48d-06ff14811609.png"
          ...
          <div>
            ...
            <div className="mt-6">
              <Link
                to="/contact"
                className="inline-block text-sm font-medium tracking-luxury uppercase text-primary hover:text-background transition-colors"
              >
                Book an Appointment →
              </Link>
            </div>
