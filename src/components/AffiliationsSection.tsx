        ...
        <div className="flex items-center justify-between gap-6 md:gap-8 overflow-x-auto flex-nowrap">
          ...
          delay: index * 0.1
              ...
              <div className="h-16 md:h-20 w-[180px] md:w-[200px] lg:w-[220px] flex items-center justify-center">
                <img src={affiliation.logo} alt={affiliation.name} loading="lazy" className="max-h-full max-w-full object-contain transition-transform duration-300 group-hover:scale-[1.02]" />
              </div>
