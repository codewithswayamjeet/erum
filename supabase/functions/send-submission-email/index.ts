...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const adminEmail = Deno.env.get("ADMIN_NOTIFICATION_EMAIL")?.trim() ?? "contact@erum.in";
    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="padding: 20px; text-align: center; margin-bottom: 20px;">
          <img src="https://erum.lovable.app/lovable-uploads/228cc8d9-9fb2-47a6-a48d-06ff14811609.png" alt="ERUM" style="height: 60px; width: auto;" />
        </div>
